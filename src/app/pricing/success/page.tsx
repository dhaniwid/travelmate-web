...
export default function SuccessPage() {
    ...
    useEffect(() => {
        setMounted(true);
        // Invalidate subscription/quota cache so the dashboard reflects PRO immediately
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden font-inter">
            ...
            <div className="max-w-md w-full bg-white/70 backdrop-blur-2xl p-8 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white relative z-10 text-center animate-in fade-in zoom-in duration-700">
                ...
                <p className="text-slate-500 font-medium mb-8 leading-relaxed">
                    Your payment was successful. We&apos;re upgrading your account to unlock hidden gems and unlimited planning.
                </p>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-amber-700 leading-normal">
                                It may take up to 5 minutes for your Pro status to activate. If it doesn&apos;t appear immediately, try refreshing your dashboard.
                            </p>
                        </div>
                    </div>
                </div>
